...
gvsummary_followup <- function(x,
  ...
  ft_tbl <- flextable_followup(x = x, vars=vars,followup=followup,
...
gvsummary_categorical <- function(x,
  ...
  ft_tbl <- flextable_categorical(x = x, vars=vars,
                                  by = by, header=header,
                                  include_overall = include_overall)
...
gvsummary_numeric <- function(x, vars,
  ...
  ft_tbl <- flextable_numeric(x = x, vars=vars, by = by, dictionary = dictionary, header=header, summary=summary)

  nm_plot <- plot_numeric(x = x, vars = vars, by = by, dictionary = dictionary, wrap_length= wrap_length,
